...
return {}, {
	...
	s(
		{ trig = "mb", name = "mathbf", descr = "mathbf" },
		fmta([[\mathbf{<>}<>]], { i(1), i(0) }),
		{ condition = math }
	),
	...
	s(
		{ trig = "!=", name = "not equals", descr = "not equals", wordTrig = false },
		{ t("\\neq") },
		{ condition = math }
	),
	s(
	...
	s(
		{ trig = "_{ii}nv", name = "inverse", descr = "inverse", wordTrig = false },
		{ t("i^{-1}") },
		{ condition = math }
	),
	s(
	...
	s(
		{ trig = "==>", name = "==>", descr = "==>", wordTrig = false },
		{ t("\\Longrightarrow ") },
		{ condition = math }
	),
