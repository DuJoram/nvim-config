...
return {}, {
  ...
  s(
    { trig = "([}A-Za-z])(%d)", name = "auto subscript", descr = "auto subscript", wordTrig = false, regTrig = true },
    {
      f(function(_, snip)
  ...
  s(
    { trig = "ceil", name = "\\left\\lceil\\right\\rceil", descr = "\\left\\lceil\\right\\rfloor", wordTrig = false },
